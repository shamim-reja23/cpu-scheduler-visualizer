...
export const ProcessTable: React.FC<ProcessTableProps> = ({
  ...
  return (
    <div className="bg-white border border-brand-border rounded-2xl shadow-sm flex flex-col flex-1 overflow-hidden min-h-75">
      <div className="p-4 md:p-6 border-b border-brand-border flex flex-col sm:flex-row justify-between items-center">
        ...
        {!compareMode && (
          <div className="flex gap-8">
            <div className="flex flex-col items-center">
              ...
              <span className="text-base md:text-lg font-bold text-brand-primary">{results.averageWaitingTime.toFixed(2)}ms</span>
            </div>
            <div className="flex flex-col items-center">
              <span className="text-[8px] font-bold text-[#9CA3AF] uppercase">Avg Turnaround</span>
              <span className="text-base md:text-lg font-bold text-brand-primary">{results.averageTurnaroundTime.toFixed(2)}ms</span>
            </div>
          </div>
        )}
      </div>
